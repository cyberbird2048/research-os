...
**E-109 | PAT-001 | Supports (adjacency only — not value, not return) | S-019 | Abstract (NBER w26477; pub. Labour Economics 2020) | quantitative estimate.** 1910–1940 transmission-line expansion raised the operative employment share +3.3pp and cut farmers −2.1pp (explains 50.5% of the operative rise). *Conf:* high (abstract). *Limits:* measures **structural transformation (employment reallocation)**, a third construct — not productivity value and not investor return; 1910–1940, no clean 1910–1935 cut. Adjacency only.
...
**E-211 | PAT-002 | Undecidable-pending-access → nuance | S-001 | G-218 & G-184, 1923→1925→1929 | growth-rate (intra-decade).** Capacity ran ahead of output mid-decade (1923→1925 capacity +37.3% vs output +20.0%, G-204 3,275→2,862) then demand caught up (1925→1929 output +50.0% vs capacity +39.0%) — a capacity **wave**, not sustained overbuild. *Conf:* high (data), medium (pattern). *Counter:* the mid-decade dip could equally read as recurring transient overbuild.
...
**E-301 | PAT-003 | Supports | S-008 | QB-1, C-16 vs C-11, Sep-1929→Jun-1932 | quantitative estimate.** The electric/gas **holding** total-return index fell −89.8% peak-to-trough (2810→287.9) vs **operating** −74.6% (6996→1778) — a 15.2pp deeper drawdown; holding retained ~40% as much residual value. *Conf:* high. *Counter:* the gap is fully explained by beta (E-307). *Limits:* S-008 caveats.

**E-302 | PAT-003 | Supports | S-008 | QB-1, C-1 vs tiers, Sep-1929→Jun-1932 | quantitative estimate.** The tiers straddle the market: holding −89.8% was worse than the all-stocks control (−82.3%), while operating −74.6% was **shallower** than the market. *Conf:* high. *Counter:* operating being defensive undercuts a simple "utilities crashed harder" story. *Limits:* S-008 caveats.

**E-303 | PAT-003 | Supports | S-008 | QB-1, C-11 & C-16, Dec-1929→Dec-1935 | quantitative estimate.** Six-year cumulative total return −40.5% (operating) vs −66.5% (holding); holding investors held ~one-third of 1929 value, operating ~60%. *Conf:* high. *Counter:* beta (E-307). *Limits:* S-008 caveats.

**E-304 | PAT-003 | Supports (existence/coverage) | S-008 | QB-1; col13 first Oct-1886, col18 first Aug-1890 | historical fact.** A genuine, separately-indexed electric/gas **operating vs holding** split exists, densely populated monthly (428/432 months 1900–1935). *Conf:* high. *Limits:* "Etc." + electric/gas mixing → neither tier is pure-electric.

**E-305 | PAT-003 | Supports | S-008 | price file cols 13 & 18, Sep-1929 & Jun-1932 | quantitative estimate.** Price-only (ex-dividend) confirms the pattern — operating −77.7% vs holding −90.7% peak-to-trough — so dividends are not what creates the tier gap. *Conf:* high. *Limits:* price file base ≈1926=100.
...
**E-308 | PAT-003 | Supports (partial) | S-008 | derived, C-11 vs C-16, full window (n=570) | quantitative estimate.** Two same-sector tiers have sharply different risk — operating β≈0.86 (defensive, below market) vs holding β≈1.38 — a ~0.5 beta gap consistent with holding-company pyramiding/leverage. *Conf:* medium. *Counter:* at index level this is indistinguishable from "the holding portfolio simply held higher-beta names." *Limits:* no capital-structure data to attribute the gap to leverage.
...
**E-310 | PAT-003 | Supports | S-008 | QB-1, C-4 vs C-11 vs C-16 | quantitative estimate.** The broad utilities aggregate (C-4, −80.4%) sits between operating (−74.6%) and holding (−89.8%) — the aggregate **masks** the operating/holding dispersion PAT-003 targets. *Conf:* medium. *Counter:* C-4 also includes traction/telephone, so it is not a pure blend of C-11+C-16. *Limits:* C-4 composition not itemized.
...
The RA requires that no Pattern's Weakens/Rejects lane be "obviously weaker" than its Supports lane. Assessment:

- **PAT-001.** Supports (coexisting): E-101–E-104, E-108, E-114, E-115 (rigorous S-018 productivity + Cowles investor-return, both load-bearing). Weakens/limitations: E-105 (markups capture), E-106 (hydro/shared attribution), E-107 (localization; national signal slow), E-113 (different-constructs — load-bearing), E-112 (financing-efficiency counter), E-116 (holding a poor pre-1920 compounder). **Balanced — the Weakens lane is strong and includes the load-bearing different-constructs constraint that caps every Supports item.** Not obviously weaker.
- **PAT-002.** Supports: E-201–E-203, E-206–E-207 (capacity/output/utilization series; the 1929→1932 utilization drop). Weakens/Rejects: E-204/E-205 (capacity rose into falling demand = pipeline, recovery not by scrapping), E-208 (utilization drop ≈55% demand shock), E-209 (recovery on frozen capacity = demand-shock signature), **E-210 (Rejects: 1920s capacity tracked demand ~1:1, flat utilization), E-218 (measurement biases understate utilization)**. **The Weakens/Rejects lane is at least as strong as — arguably stronger than — Supports; a US physical-overbuild reading is not well-supported in the 1920s and the crash-era utilization drop is majority demand shock.** Not obviously weaker.
- **PAT-003.** Supports: index-tier dispersion (E-301–E-305, E-310) + a bounded security-level sample qualitatively consistent (E-351–E-361). Weakens: **E-307 (load-bearing — the entire holding drawdown is explained by static beta; no index-level residual)**, E-306, E-309 (survivorship). Undecidable-pending-access: E-311, E-370 (the whole security-level mechanism — vintage, capital structure, delistings, liquidation, population, security-level total return). **Balanced, with the security-level mechanism explicitly Undecidable; index-tier dispersion alone is not treated as Supports for the Pattern.** Not obviously weaker.

**Conclusion:** each Pattern carries a Weakens/Rejects lane that is not obviously weaker than its Supports lane; the ledger meets the anti-confirmation gate for entry to the Evidence Sufficiency Review.

## Carried gaps / Undecidable-pending-access (for the Evidence Sufficiency Review)
...
- 4. **PAT-001 construct gap** — productivity and investor-return evidence are different constructs on different units; only coexisting divergence is establishable, never a matched-cohort value transfer.
- 5. **S-016/S-017** — orientation/framing only (S-016 not load-bearing; S-017 carries no numeric estimate).

## Stage C stop point

HIS-002 Evidence Ledger complete for the open-source scope authorized at the Source Verification Review. **Stopping for the Evidence Sufficiency Review.** No historical synthesis has been written; the Pattern Validation Matrix HIS-002 verdicts remain **pending** (not updated); no Pattern has been promoted; no `MAP-001`, `THS-001`, AI-era mapping, or investment conclusion has been created.
