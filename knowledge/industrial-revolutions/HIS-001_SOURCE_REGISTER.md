...
| Henry Tuck, *The Railway Shareholder's Manual* | Henry Tuck | 1845, 1847 & **1848 (9th ed.)** eds. | reference work | Primary | QT2, QT3, QT4; **C4 cash-flow input** | Medium-high | **verified-open** | Three eds. read on archive.org (`railwaysharehol02tuckgoog` 1845; `railwaysharehol00tuckgoog` 1847; **`railwaysharehol01tuckgoog` 1848/9th ed., located in Stage C**). Contain paid-up-capital snapshots, half-yearly dividend rates, (1845) an 1839–44 YNM price series, and (1848) a dated Parliamentary-authorization table — but **no dated call schedule** → cash-flow reconstruction is `undecidable` (ledger C-166) |
...
| "Managerial Failure in **Mid**-Victorian Britain? Corporate Expansion during a Promotion Boom" (key `B5-CampbellTurner-ManagerialFailure-2015`) | **Gareth Campbell & John D. Turner** | 2015, *Business History* (DOI 10.1080/00076791.2015.1026260) | peer-reviewed | H3, H4; C4/C5 | High | **verified-open** (full text read in Stage C) | **Stage C correction (ledger C-197):** the file previously mis-keyed as "McCartney (2024) … early Victorian" is actually this Campbell & Turner (2015) paper — confirmed from its title page. Reports industry profit/mile decline (C-195). It **cites** the YNM 10.1%/−0.3% ROE figure from a *different* paper (next row) |
| McCartney & Arnold (2001), "Capital Clamours for Profitable Investment … York and North Midland Railway" | Sean McCartney & A.J. Arnold | 2001, *Journal of Industrial History* 4(2): 94–116 | peer-reviewed | H2, H4; C4/C5 (YNM ROE) | High | **verified-paywalled / not read** | **Origin of the YNM 10.1%/−0.3% (and 14%/2.3%) return figures**, cited by Campbell & Turner (2015) and Odlyzko. Primary NOT read — claims resting on it are two-hop citations (ledger C-191/C-194/C-229) |
